...
const nav = [
  ...
  { href: '/farming', label: 'Auto-Farming', icon: '🤖' },
    ...
    <>
      ...
      {isMobile && (
        <button
          ...
          className="fixed top-4 left-4 z-[60] p-2 glass rounded-xl"
          aria-label="Menu"
        >
      ...
      <aside className={`fixed left-0 top-0 h-screen w-60 glass border-r border-white/5 flex flex-col z-50 transition-transform duration-200 ${
        ...
        <div className="p-5 border-b border-white/5">
          <h1 className="text-lg font-bold flex items-center gap-2">
            ...
            <span>AirdropFarm</span>
          </h1>
          <p className="text-[11px] text-zinc-600 mt-0.5">Auto-farming dashboard</p>
        </div>
        ...
        <div className="p-3 border-t border-white/5 space-y-2">
          <div className="glass-sm p-3 text-xs">
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <span className="text-zinc-500">Farming Engine</span>
            </div>
            <p className="text-green-400 font-medium text-[11px]">Active</p>
          </div>
